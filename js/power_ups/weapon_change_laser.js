class WeaponChangeLaser {
    constructor(player1, player2) {
        ...
        this.pwrBoxes.createMultiple(50, 'weaponLaser');
    ...
    checkCollisions(player1, player2) {
        game.physics.arcade.overlap(player1.sprite, this.pwrBoxes, function (player, pwrBox) {
            if (player.playerClassParent.weapon.currWeaponType !== 'Laser') {
                player.playerClassParent.weapon.currWeaponType = 'Laser';
                pwrBox.kill();
