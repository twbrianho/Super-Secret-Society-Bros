class WeaponChangeBlaster {
    constructor(player1, player2) {
        ...
        this.pwrBoxes.createMultiple(50, 'weaponBlaster');
    ...
    checkCollisions(player1, player2) {
        game.physics.arcade.overlap(player1.sprite, this.pwrBoxes, function (player, pwrBox) {
            if (player.playerClassParent.weapon.currWeaponType !== 'Blaster') {
                player.playerClassParent.weapon.currWeaponType = 'Blaster';
                pwrBox.kill();
