class WeaponChangeCannon {
    constructor(player1, player2) {
        ...
        this.pwrBoxes.createMultiple(50, 'weaponCannon');
    ...
    checkCollisions(player1, player2) {
        game.physics.arcade.overlap(player1.sprite, this.pwrBoxes, function (player, pwrBox) {
            if (player.playerClassParent.weapon.currWeaponType !== 'Cannon') {
                player.playerClassParent.weapon.currWeaponType = 'Cannon';
                pwrBox.kill();
